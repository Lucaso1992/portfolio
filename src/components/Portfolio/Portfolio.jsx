    ...
    return (
        ...
        <div className={styles.portfolio_container}>
            ...
            <div className={styles.works_logo_container}>
                <a href="https://www.wecontain.com.ar/" target="_blank" className={styles.anchor}><div className={styles.works_logo}>
                    <div className={styles.wecontain_container}>
                        <img src={img2} className={styles.img_logo} alt="we-contain" />
                    </div>
                    <p className={styles.works_texts}><strong>Design and development of a corporate website for a container rental company.</strong></p>
                </div>
                </a>
