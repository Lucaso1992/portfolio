...
const worksData = [
  {
    ...
    title: "LUCKY SHOP",
    img: img6,
    description: "LUCKY SHOP is an e-commerce platform built with React, aimed to deliver a seamless shopping experience. Users can browse through the catalog, filter prices and catalogs, and add items to their shopping cart,  managing their selections.",
    description_espanol: "LUCKY SHOP es un e-commerce construido con React, con el objetivo de brindar una experiencia de compra fluida. Los usuarios pueden navegar por el catálogo, filtrar por precio y catálogo y agregar productos al carrito de compras, gestionando sus selecciones.",
    containerName: "shop",
